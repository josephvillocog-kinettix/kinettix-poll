...
const CandidateCard: React.FC<CandidateCardProps> = ({ candidate, isSelected, onSelect, disabled, index }) => {
  ...
  const baseClasses = `relative rounded-lg overflow-hidden group transform transition-all duration-300 ease-in-out cursor-pointer shadow-lg bg-gradient-to-br ${gradientClass} aspect-square flex items-center justify-center p-4 text-center`;
